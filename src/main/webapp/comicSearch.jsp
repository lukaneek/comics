			    ...
			    <table class="table table-hover table-bordered">
			        ...
			        <tbody class="table-group-divider">
			            <c:forEach var="rental" items="${rentedComics}">
			                <tr>
			                    <td><a href="/book/details/${rental.comic.id}"> <c:out value="${rental.comic.title}" /></a></td>
			                    <td><a href="/book/details/${rental.comic.id}"> <img src="/uploads/cover_pictures/${rental.comic.coverImage}" alt="${rental.comic.title} Cover" style="width:150px;"></a></td>
